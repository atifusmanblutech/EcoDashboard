...
# 
# # # 1. Reading file
# dataframe <- read_csv("data_numbers.csv")
# custData1 <- na.omit(dataframe)
# 
# custData <- custData1[1:20000,]
# 
...
#   arrange(desc(revenue))
# 
# custSummaryDF <- custSummaryDF %>% filter(transactions > 1, revenue > 50)
# 
# #head(custSummary, n = 10)
# 
# custSummaryBasic <- custData %>%
...
#     
#     segmenationType <- input$Segmentation
#     if(input$choice_CustomerType == 'topCustomers')
#     {
#       top20customers <- head(customerBreakdown11,input$numOfCustomersTop)
#       myTitle <- paste("Showing Total Revenue of Top ", input$numOfCustomersTop , " Customers")
#       
#     }
#     else if(input$choice_CustomerType == 'bottomCustomers')
#     {
...
#     if(input$choice_CustomerType == "topCustomers")
#     {
#       selectedCustomers <- head(customerBreakdown11,input$numOfCustomersTop)
#       
#     }
#     else(input$choice_CustomerType == "bottomCustomers")
#     {
#       
#       selectedCustomers <- tail(customerBreakdown11,input$numOfCustomersBottom)
#     }
#     
#     day <- selectedCustomers$mostDay
#     custid<-selectedCustomers$CustomerID
...
#   observeEvent(input$cusPersonalizedCampaignSms, {
#     
#     #selectedCustomers2 <- head(customerBreakdown11,input$numOfCustomersTop)
#     
#     if(input$choice_CustomerType == "topCustomers")
#     {
#       selectedCustomers2 <- head(customerBreakdown11,input$numOfCustomersTop)
