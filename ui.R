...
dashboardPage( 
  ...
  dashboardSidebar( width = 60, collapsed = TRUE,
                    sidebarMenu(id = "sidebar",
                                ...
                                menuItem("", icon = icon("bar-chart-o","fa-2x",lib = "font-awesome"), tabName = "tab_combinedInsights")
                    ...
                    div(id="div_weekdayMarketing",
                        ...
                        conditionalPanel(
                          ...
                          conditionalPanel("input.choice_autoManualEmail == 'Automatic'",
                                           ...
                                           br(),
                                           actionButton("minEmailCampaign", "Campaign for Min Revenue Day",style = "color: #fff; background-color: #337ab7; border-color: #2e6da4; width: 100%; padding-left: 2dp: margin: 5dp;"
                                           ),
                     ...
                     tabPanel("Launch",
                              ...
                              shinyjs::hidden(
                                div(id="div_combineMarketingNow",
                                    ...
                                    # dateInput('input_marketingDate_CombNow',
                                    #           label = 'Select Date: yyyy-mm-dd',
                                    #           value = Sys.Date()
                                    # ),
                                    # selectInput(
                                    #   "input_customerMarketingChoice_CombNow",
                                    #   "Please Select Customer Type",
                                    #   choices = c("Top Customers" = "topCustomers", "Churning Customers" = "btmCustomers"), selected = "topCustomers"),
                                    uiOutput("output_customerMarketingChoice_CombNow"),
                                    br(),
                                    uiOutput("output_productMarketing_CombNow"),
                                    
                                    
                                    
                                    br(),
                                    uiOutput("output_locationMarketing_CombNow"),
                                    br(),
                     ...
                     tabPanel("Schedule",
                              ...
                              shinyjs::hidden(
                                div(id="div_combineMarketing",
                                    ...
                                    # Set to current time
                                    timeInput("input_marketingTime_Comb", "Time:", value = Sys.time()),
                                    selectInput(
